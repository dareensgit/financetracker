...
const TransactionDetails = () => {
  ...
  const { getTransactionById, removeTransaction } = useData()
  ...
  const amountClass =
    transaction && transaction.type === 'income'
      ? 'text-matcha dark:text-green-400 font-semibold text-lg'
      : 'text-honey-drizzle dark:text-orange-400 font-semibold text-lg'
          ...
          <>
            <div className="space-y-4 divide-y divide-honey-drizzle/50 dark:divide-slate-700">
              <div className="pt-4 first:pt-0">
                ...
                <p className="text-coffee-grounds dark:text-gray-100 font-medium">
              ...
              <div className="pt-4">
                ...
                <p className="text-coffee-grounds/90 dark:text-gray-300">
            ...
            <div className="mt-8 flex justify-end gap-3">
              <button
                ...
                className="px-4 py-2 border border-honey-drizzle dark:border-slate-600 rounded-lg text-coffee-grounds/90 dark:text-gray-300 hover:bg-honey-drizzle/10 dark:hover:bg-slate-700 transition-colors"
              >
                Back to List
              </button>
              <button
                ...
                className="px-4 py-2 bg-gradient-to-r from-lemonade to-honey-drizzle dark:from-yellow-500 dark:to-orange-500 hover:bg-opacity-90 text-coffee-grounds dark:text-gray-900 font-bold rounded-lg shadow-md transition-colors"
              >
                Edit
              </button>
              <button
                ...
                disabled={deleting}
                className="px-4 py-2 bg-transparent border border-coffee-grounds dark:border-gray-600 text-coffee-grounds dark:text-gray-300 hover:bg-coffee-grounds/10 dark:hover:bg-slate-700 rounded-lg shadow transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
              >
