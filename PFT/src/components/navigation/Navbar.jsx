...
const Navbar = ({ currentPage = '' }) => {
  ...
  return (
    <nav className="bg-sea-blue dark:bg-slate-800 shadow-lg px-4 md:px-6 py-3">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <button
            ...
            className="bg-lemonade hover:bg-opacity-90 text-coffee-grounds font-bold px-4 py-2 rounded-lg shadow-md">
            + Add Transaction
          </button>
          <button
      ...
      <div id="mobile-menu" className={`md:hidden ${mobileMenuOpen ? '' : 'hidden'} mt-4 space-y-2`}>
        ...
        <button
          onClick={() => navigate('/transactions/add')}
          className="w-full bg-lemonade hover:bg-opacity-90 text-coffee-grounds font-bold px-4 py-2 rounded-lg shadow-md">
          + Add Transaction
        </button>
