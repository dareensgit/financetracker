        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link to="/dashboard" className="bg-sea-blue dark:bg-blue-600 hover:bg-sea-blue/90 dark:hover:bg-blue-700 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-all shadow-lg hover:shadow-xl text-center">
                Get Started — It's Free
              </Link>
              <a href="#demo" className="bg-white dark:bg-slate-800 hover:bg-gray-50 dark:hover:bg-slate-700 text-sea-blue dark:text-blue-400 border-2 border-sea-blue dark:border-blue-600 px-8 py-4 rounded-lg font-semibold text-lg transition-all text-center">
                See Demo
              </a>
            </div>
          </div>
